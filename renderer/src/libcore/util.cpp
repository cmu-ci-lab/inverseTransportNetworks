...
// void coordinateSystemAD(const VectorAD &a, VectorAD &b, VectorAD &c) {
// 	if (std::abs(a.x) > std::abs(a.y)) {
// 		FloatAD invLen = 1.0f / std::sqrt(a.x * a.x + a.z * a.z);
// 		c = VectorAD(a.z * invLen, 0.0f, -a.x * invLen);
// 	} else {
// 		FloatAD invLen = 1.0f / std::sqrt(a.y * a.y + a.z * a.z);
// 		c = VectorAD(0.0f, a.z * invLen, -a.y * invLen);
// 	}
// 	b = cross(c, a);
// }
