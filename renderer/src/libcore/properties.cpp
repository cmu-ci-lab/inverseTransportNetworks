...
typedef boost::variant<
	bool, int64_t, Float, FloatAD, Point, Vector,Vector_AD, Transform, AnimatedTransform *,
	Spectrum, Spectrum_AD, std::string, Properties::Data> ElementData;
...
DEFINE_PROPERTY_ACCESSOR(FloatAD, FloatAD, FloatAD, floatAD)
DEFINE_PROPERTY_ACCESSOR(Point, Point, Point, point)
DEFINE_PROPERTY_ACCESSOR(Vector, Vector, Vector, vector)
DEFINE_PROPERTY_ACCESSOR(Vector_AD, Vector_AD, Vector_AD, vector_AD)
...
DEFINE_PROPERTY_ACCESSOR(Spectrum_AD, Spectrum_AD, Spectrum_AD, spectrum_AD)
...
namespace {
	...
	public:
		...
		Properties::EPropertyType operator()(const FloatAD &) const           { return Properties::EFloatAD; }		
		Properties::EPropertyType operator()(const FloatAD_shared &) const    { return Properties::EFloatAD_shared; }	
		...
		Properties::EPropertyType operator()(const Vector_AD &) const            { return Properties::EVector_AD; }		
		...
		Properties::EPropertyType operator()(const Spectrum_AD &) const          { return Properties::ESpectrum_AD; }		
	...
	public:
		...
		bool operator()(const FloatAD &v) const             { const FloatAD *v2 = boost::get<FloatAD>(ref); return v2 ? (v == *v2) : false; }
		...
		bool operator()(const Vector_AD &v) const            { const Vector_AD *v2 = boost::get<Vector_AD>(ref); return v2 ? (v == *v2) : false; }		
		...
		bool operator()(const Spectrum_AD &v) const          { const Spectrum_AD *v2 = boost::get<Spectrum_AD>(ref); return v2 ? (v == *v2) : false; }		
	...
	public:
		...
		void operator()(const Spectrum_AD &v) const       { oss << v[0].val(); }		
