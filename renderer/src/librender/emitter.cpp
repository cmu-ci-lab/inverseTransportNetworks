...
std::vector<ref<Shape>> AbstractEmitter::createShapes(const Scene *scene) {
	return {};
}


std::vector<AABB> AbstractEmitter::getAABBs(){
	return {};
}
...
Spectrum_AD AbstractEmitter::sampleDirectAD(DirectSamplingRecord &dRec, const Point2 &sample) const {
	NotImplementedError("sampleDirectAD");
}


Spectrum AbstractEmitter::evalDirect(const DirectSamplingRecord &dRec, Float &pdf) const {
	NotImplementedError("evalDirect");
}
...
Spectrum_AD Emitter::evalAD(const Intersection &its, const Vector &d) const {
	NotImplementedError("evalAD");
}

bool Emitter::isRegularEnv() const {
	NotImplementedError("isRegularEnv");
}
Spectrum_AD Emitter::evalEnvironment(const RayDifferential &ray) const {
	NotImplementedError("evalEnvironment");
}
Spectrum Emitter::evalEnvironment_sky(const RayDifferential &ray) const {
	NotImplementedError("evalEnvironment");
}
