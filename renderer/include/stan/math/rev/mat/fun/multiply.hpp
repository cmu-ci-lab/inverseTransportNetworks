  ...
  namespace math {
    ...
    public:
      ...
      multiply_mat_vari(const Eigen::Matrix<TA, RA, CA>& A,
        ...
        : vari(0.0),
          ...
          Ad_(mitsuba::StanStack::getInstance()->memalloc_.alloc_array<double>(A_size_)),
          Bd_(mitsuba::StanStack::getInstance()->memalloc_.alloc_array<double>(B_size_)),
          variRefA_(mitsuba::StanStack::getInstance()->memalloc_.alloc_array<vari*>(A_size_)),
          variRefB_(mitsuba::StanStack::getInstance()->memalloc_.alloc_array<vari*>(B_size_)),
          variRefAB_(mitsuba::StanStack::getInstance()->memalloc_.alloc_array<vari*>(A_rows_
                                                                  * B_cols_)) {
        using Eigen::Map;
    ...
    public:
      ...
      multiply_mat_vari(const Eigen::Matrix<TA, 1, CA>& A,
        ...
        : vari(0.0),
          size_(A.cols()),
          Ad_(mitsuba::StanStack::getInstance()->memalloc_.alloc_array<double>(size_)),
          Bd_(mitsuba::StanStack::getInstance()->memalloc_.alloc_array<double>(size_)),
          variRefA_(mitsuba::StanStack::getInstance()->memalloc_.alloc_array<vari*>(size_)),
          variRefB_(mitsuba::StanStack::getInstance()->memalloc_.alloc_array<vari*>(size_)) {
        using Eigen::Map;
    ...
    public:
       ...
       * It is critical for the efficiency of this object
       * that the constructor create new varis that aren't
       * popped onto the , but rather are
       * popped onto the var_nochain_stack_. This is
       * controlled to the second argument to
       * vari's constructor.
       *
