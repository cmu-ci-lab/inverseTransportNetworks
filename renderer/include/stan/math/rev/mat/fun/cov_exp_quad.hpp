    ...
    public:
      ...
      cov_exp_quad_vari(const std::vector<T_x>& x,
        ...
        : vari(0.0),
          ...
          dist_(mitsuba::StanStack::getInstance()->memalloc_.alloc_array<double>(size_ltri_)),
          l_vari_(l.vi_), sigma_vari_(sigma.vi_),
          cov_lower_(mitsuba::StanStack::getInstance()->memalloc_.alloc_array<vari*>(size_ltri_)),
          cov_diag_(mitsuba::StanStack::getInstance()->memalloc_.alloc_array<vari*>(size_)) {
