...
namespace stan {
  namespace math {
    ...
    namespace {
      ...
      public:
        ...
        squared_distance_vv_vari(const Eigen::Matrix<var, R1, C1> &v1,
          ...
          v1_ = reinterpret_cast<vari**>(mitsuba::StanStack::getInstance()->memalloc_
                                         .alloc(length_*sizeof(vari*)));
          for (size_t i = 0; i < length_; i++)
            v1_[i] = v1(i).vi_;

          v2_ = reinterpret_cast<vari**>(mitsuba::StanStack::getInstance()->memalloc_
                                         .alloc(length_*sizeof(vari*)));
          for (size_t i = 0; i < length_; i++)
            v2_[i] = v2(i).vi_;
        }
      ...
      public:
        ...
        squared_distance_vd_vari(const Eigen::Matrix<var, R1, C1> &v1,
          ...
          v2_ = reinterpret_cast<double*>(mitsuba::StanStack::getInstance()->memalloc_
    ...
    inline var squared_distance(const Eigen::Matrix<var, R1, C1>& v1,
      ...
      check_matching_sizes("squared_distance",
                           "v1", v1,
                           "v2", v2);
