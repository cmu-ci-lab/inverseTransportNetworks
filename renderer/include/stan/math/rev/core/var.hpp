...
namespace stan {
  namespace math {
    ...
    public:
      ...
      var(float x, int tid) : vi_(new vari(static_cast<double>(x), tid)) { }  // NOLINT
      ...
      var(double x, int tid) : vi_(new vari(x, tid)) { }  // NOLINT
      ...
      var(long double x, int tid) : vi_(new vari(x, tid)) { }  // NOLINT
      ...
      var(bool x, int tid) : vi_(new vari(static_cast<double>(x), tid)) { }  // NOLINT
      ...
      var(char x, int tid) : vi_(new vari(static_cast<double>(x), tid)) { }  // NOLINT
      ...
      var(short x, int tid) : vi_(new vari(static_cast<double>(x), tid)) { }  // NOLINT
      ...
      var(int x, int tid) : vi_(new vari(static_cast<double>(x), tid)) { }  // NOLINT
      ...
      var(long x, int tid) : vi_(new vari(static_cast<double>(x), tid)) { }  // NOLINT
      ...
      var(unsigned char x, int tid)  // NOLINT(runtime/explicit)
      : vi_(new vari(static_cast<double>(x), tid)) { }
      ...
      var(unsigned short x, int tid) : vi_(new vari(static_cast<double>(x), tid)) { }
      ...
      var(unsigned int x, int tid) : vi_(new vari(static_cast<double>(x), tid)) { }  // NOLINT
      ...
      var(unsigned long x, int tid) : vi_(new vari(static_cast<double>(x), tid)) { }  // NOLINT
      ...
      var(size_t x, int tid) : vi_(new vari(static_cast<double>(x), tid)) { }  // NOLINT
      ...
      var(ptrdiff_t x, int tid) : vi_(new vari(static_cast<double>(x), tid)) { }  // NOLINT
#endif
      ...
      var(__float128 x, int tid) : vi_(new vari(static_cast<double>(x), tid)) { }  // NOLINT

#endif

      operator float() {
          return (float) vi_->val_;
      }
      // operator double()& {
      //     return (double) vi_->val_;
      // }
      operator size_t() {
          return (size_t) vi_->val_;
      }        
      // operator int()& {
      //     return (int) vi_->val_;
      // }
      // operator long double ()& {
      //     return (long double ) vi_->val_;
      // }        
      // operator bool()& {
      //     return (bool) vi_->val_;
      // } 
      // operator char()& {
      //     return (char) vi_->val_;
      // }              
      // operator short()& {
      //     return (short) vi_->val_;
      // }
      // operator long()& {
      //     return (long) vi_->val_;
      // }
      // operator unsigned char()& {
      //     return (unsigned char) vi_->val_;
      // }

      // operator unsigned int()& {
      //     return (unsigned int) vi_->val_;
      // }
      // operator unsigned long()& {
      //     return (unsigned long) vi_->val_;
      // }
      // operator unsigned short()& {
      //     return (unsigned short) vi_->val_;
      // }
