...
public:
	 ...
	 */
	virtual Spectrum_AD eval(const PhaseFunctionSamplingRecord &pRec) const = 0;
	...
	virtual Spectrum_AD sampleAD(PhaseFunctionSamplingRecord &pRec,
		Sampler *sampler) const = 0;
	...
	virtual Spectrum_AD pdfAD(const PhaseFunctionSamplingRecord &pRec) const;
	/**
	 ...
	 */
	virtual FloatAD getMeanCosine() const;
