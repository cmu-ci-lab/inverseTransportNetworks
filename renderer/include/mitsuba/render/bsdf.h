...
public:
	...
	virtual Spectrum_AD sampleAD(BSDFSamplingRecord &bRec, const Point2 &sample) const = 0;
	/**
	...
	virtual Spectrum_AD sampleAD(BSDFSamplingRecord &bRec, Float &pdf,
		const Point2 &sample) const = 0;
	/**
	 ...
	 */
	virtual Spectrum_AD eval(const BSDFSamplingRecord &bRec,
		EMeasure measure = ESolidAngle) const = 0;
	

	// virtual Spectrum_AD eval_AD(const BSDFSamplingRecord &bRec,Helptest* helpTest,
	// 	EMeasure measure = ESolidAngle) const = 0;
	/**   EMeasure measure
	...
	virtual Float pdf(const BSDFSamplingRecord &bRec,
		EMeasure measure = ESolidAngle) const = 0;
	virtual FloatAD pdfAD(const BSDFSamplingRecord &bRec,
		EMeasure measure = ESolidAngle) const = 0;
	/**
	 ...
	 */
	virtual FloatAD getRoughness(const Intersection &its, int index) const;
